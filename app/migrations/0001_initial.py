# Generated by Django 5.1.3 on 2026-01-07 16:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("is_work_status_changed_today", models.BooleanField(default=False)),
                (
                    "work_status",
                    models.IntegerField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("remarks", models.CharField(blank=True, default="", max_length=20)),
                (
                    "weekday",
                    models.IntegerField(
                        choices=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("place", models.CharField(blank=True, default="", max_length=20)),
                ("remarks", models.CharField(blank=True, default="", max_length=20)),
                ("is_changed_today", models.BooleanField(default=False)),
                (
                    "customer",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
